...
2. Click **"Open from File"** (bottom left).
3. Navigate to this project folder and select `index.html`.
4. The wallpaper will load, and you can adjust settings in the right-hand panel.
...
- `css/style.css`: Visual styling, gradients, and keyframe animations.
- `js/script.js`: Logic for fish creation, movement, and parallax.
- `project.json`: Metadata and property definitions for Wallpaper Engine.
- `assets/`: Contains all fish sprites and background textures.
